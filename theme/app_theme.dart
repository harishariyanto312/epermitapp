...
import 'package:epermits/theme/theme_type.dart';
...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
        ...
        primary: Color.fromARGB(255, 230, 33, 42),
        onPrimary: Color(0xffeeeeee),
        primaryVariant: Color(0xff3C4EC5),
        // secondary: Color(0xff3C4EC5),
        secondary: Color.fromARGB(255, 230, 33, 42),
        secondaryVariant: Color(0xffeeeeee),
        onSecondary: Color(0xffeeeeee),
        surface: Color(0xffeeeeee),
        // background: Color(0xffeeeeee),
        background: Color.fromARGB(255, 230, 33, 42),
        onBackground: Color(0xff495057)),
        // onBackground: Color.fromARGB(255, 247, 202, 48)),
